export default {
  'menu.chatbotManagement': 'Chatbot Management',
  'menu.chatbotManagement.listchatbot': 'Chatbot List',
  'menu.chatbotManagement.createNewChatbot': 'Create New Chatbot',
  'menu.chatbotManagement.createNewChatbot.basicInfoChatbot': 'Basic Info',
  'menu.chatbotManagement.createNewChatbot.inputDefaultQuestion': 'Default Question',
  'menu.chatbotManagement.inputPersonalData': 'Custom Question',
  'menu.user': 'Account',
  'menu.user.profile': 'UserPage',
  'menu.user.setting': 'Setting',
  'menu.home': 'Home',
  'menu.login': 'Login',
