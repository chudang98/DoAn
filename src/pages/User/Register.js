  ...
  handleSubmit = e => {
    ...
    form.validateFields({ force: true }, (err, values) => {
      ...
      if (!err) {
        ...
        values.soDienThoai = '+' + prefix + values.soDienThoai;
        ...
        <Form onSubmit={this.handleSubmit}>
          <FormItem>
            {getFieldDecorator('username', {
              rules: [{ required: true, message: 'Nhập tên tài khoản' }, ...rules.username],
            })(
              <Input
                size="large"
          ...
          <FormItem labelCol={{ span: 6 }} wrapperCol={{ span: 18 }} label="Ảnh đại diện">
