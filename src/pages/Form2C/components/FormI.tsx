...
import { Select, Card, Row, Col, Form, Input, DatePicker, Upload, message } from 'antd';
          ...
          >
            <GridContent className={styles.card_form1}>
              <Row type="flex" justify="center" align="middle">
                <Col span={20} type="flex" justify="center" align="middle">
              ...
              <Row type="flex" justify="space-around" align="middle">
                <Col span={20}>
                  ...
                  <Form {...formItemLayout} labelAlign="left">
                    ...
                    <Form.Item
                      extra="(Số nhà, đường phố, thành phố, xóm, thôn, xã, huyện, tỉnh)"
                      label={
                        <span>
                    ...
                    <Form.Item
                      ...
                      label={
                        <span>
                          <span className={styles.form2c_red_text}>9. </span>Nơi ở hiện nay: thường
                          chú
                        </span>
                      }
                    >
                          ...
                          <Input.Group className={styles.form2c_input_addon}>
                            <Col span={10} className={styles.textarea_addon}>
                              <p>
                                ...
                                hội nào ở nước ngoài (làm gì, tổ chức nào, đặt trụ sở ở đâu
                                .........?):
                              </p>
                            </Col>
                            <Col span={14} className={styles.h_100}>
